...
var EmployeeService = /** @class */ (function () {
    function EmployeeService(http, errorService, router, error2Service) {
        this.http = http;
    ...
    EmployeeService.prototype.isLoggedIn = function () {
    ...
    EmployeeService.prototype.addTask = function (task) {
        ...
        return this.http.post('https://cpsulli.herokuapp.com/task' + token, body, { headers: headers })
            ...
            var task = new Task(result.obj.content, result.obj.dueDate, result.obj.completed, result.obj._id, result.obj.employee, result.obj.employeeFirstName, result.obj.employeeLastName, result.obj.company, true);
            ...
            .catch(function (error) {
            _this.error2Service.handleError(error.json());
            return Observable.throw(error.json());
        });
    };
    EmployeeService.prototype.getTasks = function () {
        ...
        return this.http.get('https://cpsulli.herokuapp.com/task' + token, { headers: headers })
            ...
            for (var _i = 0, tasks_1 = tasks; _i < tasks_1.length; _i++) {
                var task = tasks_1[_i];
                transformedTasks.push(new Task(task.content, task.dueDate, task.completed, task._id, task.employee, task.employeeFirstName, task.employeeLastName, task.company));
            }
    ...
    EmployeeService.prototype.deleteTask = function (task) {
        var _this = this;
    ...
    EmployeeService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [Http, ErrorService, Router, Error2Service])
    ], EmployeeService);
